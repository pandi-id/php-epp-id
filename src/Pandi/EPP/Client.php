...
use Pandi\EPP\Frame\Command\Login as LoginCommand;
use Pandi\EPP\Frame\Command\Logout as LogoutCommand;
use Pandi\EPP\Frame\Response as ResponseFrame;
use Pandi\EPP\Frame\ResponseFactory;
use Exception;
